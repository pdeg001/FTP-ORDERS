...
public class b4xfloattextfield extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "nl.pdeg.ftporder.b4xfloattextfield");
            if (htSubs == null) {
...
public nl.pdeg.ftporder.b4xfloattextfield  _getnextfield() throws Exception{
...
if (_mnexttextfield.IsInitialized /*boolean*/ ()==__c.False || (_mnexttextfield).equals((nl.pdeg.ftporder.b4xfloattextfield)(this))) { 
...
public String  _setnextfield(nl.pdeg.ftporder.b4xfloattextfield _field) throws Exception{
...
_mnexttextfield = (nl.pdeg.ftporder.b4xfloattextfield)(_o);
...
public ResumableSub_SwitchFromPasswordToRegular(nl.pdeg.ftporder.b4xfloattextfield parent,boolean _toregular) {
this.parent = parent;
...
if (_mnexttextfield.IsInitialized /*boolean*/ () && (_mnexttextfield).equals((nl.pdeg.ftporder.b4xfloattextfield)(this)) == false) { 
