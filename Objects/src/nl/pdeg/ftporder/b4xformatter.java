...
public class b4xformatter extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "nl.pdeg.ftporder.b4xformatter");
            if (htSubs == null) {
...
public String  _addformatdata(nl.pdeg.ftporder.b4xformatter._b4xformatdata _data,double _rangestart,double _rangeend,boolean _includeedges) throws Exception{
double _factor = 0;
...
public nl.pdeg.ftporder.b4xformatter._b4xformatdata  _copyformatdata(nl.pdeg.ftporder.b4xformatter._b4xformatdata _data) throws Exception{
...
public nl.pdeg.ftporder.b4xformatter._b4xformatdata  _createdefaultformat() throws Exception{
nl.pdeg.ftporder.b4xformatter._b4xformatdata _d = null;
...
public nl.pdeg.ftporder.b4xformatter._b4xformatdata  _getdefaultformat() throws Exception{
...
if (true) return (nl.pdeg.ftporder.b4xformatter._b4xformatdata)(_formats.Get((int) (0)));
 //BA.debugLineNum = 78;BA.debugLine="End Sub";
return null;
}
public nl.pdeg.ftporder.b4xformatter._b4xformatdata  _getformatdata(double _number) throws Exception{
int _i = 0;
nl.pdeg.ftporder.b4xformatter._b4xformatdata _d = null;
...
_d = (nl.pdeg.ftporder.b4xformatter._b4xformatdata)(_formats.Get(_i));
...
public nl.pdeg.ftporder.b4xformatter._b4xformatdata  _newformatdata() throws Exception{
