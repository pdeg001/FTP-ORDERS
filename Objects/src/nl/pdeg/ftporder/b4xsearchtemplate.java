...
public class b4xsearchtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "nl.pdeg.ftporder.b4xsearchtemplate");
            if (htSubs == null) {
...
public ResumableSub_Show(nl.pdeg.ftporder.b4xsearchtemplate parent,nl.pdeg.ftporder.b4xdialog _dialog) {
this.parent = parent;
